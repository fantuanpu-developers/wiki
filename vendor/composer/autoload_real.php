...
class ComposerAutoloaderInite1c73d08b6d341275ab8d69d1355d4d1
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInite1c73d08b6d341275ab8d69d1355d4d1::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiree1c73d08b6d341275ab8d69d1355d4d1($fileIdentifier, $file);
        }
...
function composerRequiree1c73d08b6d341275ab8d69d1355d4d1($fileIdentifier, $file)
{
